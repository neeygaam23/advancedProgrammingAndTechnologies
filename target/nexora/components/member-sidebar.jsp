<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <% String currentPage=request.getParameter("page"); if (currentPage==null) currentPage="home" ; String
        memberName=(String) session.getAttribute("memberName"); if (memberName==null) memberName="Nishan Rai" ; String
        initials=(String) session.getAttribute("initials"); if (initials==null) initials="NR" ; %>
